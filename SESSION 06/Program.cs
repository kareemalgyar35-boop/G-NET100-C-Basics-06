namespace SESSION_06
{
    ...
    { 1, 4 }};
            ...
            ///ازاي او يمكن كا تعريف سوال بحتاج توضيح لي السوال اكتر عشان اعرف ابدا في بصراحه سعات بستعين بي النت وبتبقا الحاجه الا في دماغي بس السوال محتاج افهمو اكتر
